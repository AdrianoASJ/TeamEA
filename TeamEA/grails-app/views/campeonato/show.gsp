...
<html>
    ...
    <body>
        ...
        <div id="show-campeonato" class="content scaffold-show" role="main">
            ...
            <f:display bean="campeonato" />
            <g:form resource="${this.campeonato}" method="DELETE">
                <fieldset class="buttons">
                    <g:link class="edit" action="edit" resource="${this.campeonato}"><g:message code="default.button.edit.label" default="Edit" /></g:link>
