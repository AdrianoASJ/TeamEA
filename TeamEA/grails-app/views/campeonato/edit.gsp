...
<html>
    ...
    <body>
        ...
        <div id="edit-campeonato" class="content scaffold-edit" role="main">
            ...
            <g:hasErrors bean="${this.campeonato}">
            <ul class="errors" role="alert">
                <g:eachError bean="${this.campeonato}" var="error">
                <li <g:if test="${error in org.springframework.validation.FieldError}">data-field-id="${error.field}"</g:if>><g:message error="${error}"/></li>
                </g:eachError>
            </ul>
            </g:hasErrors>
            <g:form resource="${this.campeonato}" method="PUT">
                <g:hiddenField name="version" value="${this.campeonato?.version}" />
                <fieldset class="form">
                    <f:all bean="campeonato"/>
                </fieldset>
