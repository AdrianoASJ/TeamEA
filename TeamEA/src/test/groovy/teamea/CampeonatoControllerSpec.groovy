...
class CampeonatoControllerSpec extends Specification {
    ...
    void "Test the index action returns the correct model"() {
        ...
        !model.campeonatoList
        model.campeonatoCount == 0
    }
    ...
    void "Test the save action with an invalid instance"() {
        given:
        controller.campeonatoService = Mock(CampeonatoService) {
            1 * save(_ as Campeonato) >> { Campeonato campeonato ->
                throw new ValidationException("Invalid instance", campeonato.errors)
            }
        }
    ...
    void "Test the show action with a valid id"() {
        ...
        model.campeonato instanceof Campeonato
    }
    ...
    void "Test the update action with an invalid instance"() {
        ...
        request.contentType = FORM_CONTENT_TYPE
        request.method = 'PUT'
        controller.update(new Campeonato())
